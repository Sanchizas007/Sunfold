...
STRINGS = {
    ...
    "history.calendar.previousMonth": ("Previous month", "Попередній місяць", "Предыдущий месяц"),
    "history.calendar.nextMonth": ("Next month", "Наступний місяць", "Следующий месяц"),
    "history.editor.feeling.value": ("%lld of 5", "%lld з 5", "%lld из 5"),
    ...
    "onboarding.health.blocked": (
        "Tick the box above to continue.",
        "Позначте пункт вище, щоб продовжити.",
        "Отметьте пункт выше, чтобы продолжить.",
    ),
