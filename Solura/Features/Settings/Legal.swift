...
/// Everywhere Solura points the user at a legal or support destination.
///
...
/// the licence Solura ships under.
nonisolated enum Legal {
    /// Hosted policy, submitted in App Store Connect metadata as well.
    static let privacyPolicyURL = URL(string: "https://solura.app/privacy")!
    ...
    static let supportURL = URL(string: "https://solura.app/support")!
    static let supportEmail = "support@solura.app"
