...
struct PaywallScreen: View {
    ...
    private func planCard(_ product: SoluraProduct) -> some View {
    ...
    private func title(for term: SoluraProduct.Term) -> LocalizedStringKey {
        switch term {
    ...
    private func subtitle(for product: SoluraProduct) -> String {
        switch product.term {
        case .monthly:
