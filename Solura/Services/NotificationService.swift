...
/// Local notifications only — Solura has no server, no push token and no APNs
...
final class NotificationService {
    ...
    private enum ID {
        static let fastComplete = "solura.fast.complete"
        static let fastEndingSoon = "solura.fast.endingSoon"
        static let eatingWindowEnd = "solura.window.end"
    ...
    /// Replaces every pending Solura notification with the set implied by a
